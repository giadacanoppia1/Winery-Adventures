...
la regola per usarla è una sola: ogni blocco prende un dataframe polars e
...
class BaseWineryAnalyzer(ABC):
    ...
    dal passaggio prima, li elabora e li passa al prossimo.
    ...
    def analyze_data(self, df: pl.DataFrame) -> pl.DataFrame:
        ...
        Raises:
            notimplementederror: se una classe figlia non crea questo metodo.
        """
